...
namespace tut {
    ...
    void Tutorial::tetris() {
        ...
        debug_data.max_site_iter_x = 0;
        debug_data.max_site_iter_last_placed_x = vector<int>();
        debug_data.max_site_iter_cell = 0;
...
//            printf("%s\n", cell->getName().c_str());
            ...
            for (int row_i = approx_row; row_i < rows.size(); row_i++) {
                ...
                if (debug_data.site_iter > debug_data.max_site_iter) {
                    ...
                    debug_data.max_site_iter_x = (target_x - row_start)/site_width;
                    debug_data.max_site_iter_cell = cell->getName().c_str();

                    debug_data.max_site_iter_last_placed_x.clear();
                    for (dbInst* curr_cell : last_placed_per_row[row_i]) {
                        int x = curr_cell->getBBox()->xMax();
                        debug_data.max_site_iter_last_placed_x.push_back((x - row_start)/site_width);
                    }
                }
...
//                printf("%d\n", debug_data.site_iter);
            ...
            if (debug_data.row_iter > debug_data.max_row_iter) debug_data.max_row_iter = debug_data.row_iter;
        ...
        printf("max_cell = %s\n", debug_data.max_site_iter_cell);
        printf("max_site_iter = %d\n", debug_data.max_site_iter);
        printf("max_site_iter_x = %d\n", debug_data.max_site_iter_x);
        for (int curr_site : debug_data.max_site_iter_last_placed_x) {
            printf("%d ", curr_site);
        }
        printf("\n\n");
